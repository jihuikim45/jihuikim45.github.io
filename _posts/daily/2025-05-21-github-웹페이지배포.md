...
`README.md` 파일은 *이 저장소가 어떤 프로젝트인지* 소개하는 첫인상이다.  
...
*VS Code 하단 TERMINAL에서 바로 명령어 입력*
...
> ☁️ **GitHub**: 그 소스를 저장하는 온라인 공간

---

## 💡 Tip

1. CSS, 이미지, JS 파일까지 **모두 함께 업로드**해야 웹페이지가 정상 작동해요
2. 파일명에는 **공백, 한글, 특수문자**를 사용하지 않는 게 좋아요
